...
Once the `conda-forge` channel has been enabled, `_openmp_mutex, binutils_impl_, gcc_impl_, gfortran_impl_, gxx_impl_, libgcc-ng, libgfortran-ng, libgomp, libstdcxx-ng` can be installed with:

```
conda install _openmp_mutex binutils_impl_ gcc_impl_ gfortran_impl_ gxx_impl_ libgcc-ng libgfortran-ng libgomp libstdcxx-ng
```
