      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8107&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ctng-compilers-feedstock?branchName=master&jobName=linux&configuration=linux_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>linux_aarch64</td>
...
Once the `conda-forge` channel has been enabled, `_openmp_mutex, gcc_impl_linux-ppc64le, gfortran_impl_linux-ppc64le, gxx_impl_linux-ppc64le, libgcc-devel_linux-ppc64le, libgcc-ng, libgfortran-ng, libgfortran5, libgomp, libstdcxx-devel_linux-ppc64le, libstdcxx-ng` can be installed with:

```
conda install _openmp_mutex gcc_impl_linux-ppc64le gfortran_impl_linux-ppc64le gxx_impl_linux-ppc64le libgcc-devel_linux-ppc64le libgcc-ng libgfortran-ng libgfortran5 libgomp libstdcxx-devel_linux-ppc64le libstdcxx-ng
```
